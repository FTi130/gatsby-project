...
function createPostPage(createPage, graphql, kind, parentPath, parentTitle) {
    return new Promise((resolve, reject) => {
        ...
        resolve(
          ...
          {
            allMarkdownRemark(
              sort: { fields: [frontmatter___title, frontmatter___date], order: [ASC,DESC] }, limit: 1000,
...
exports.createPages = ({ graphql, actions }) => {
    ...
    return Promise.all([
        ...
        createPostPage(createPage, graphql,  'talk', '/', 'Walk home'),  // here is a dependency, /talks/
        // try to rename the /talks/ folder to /projects/
